...
Item {
    ...
    readonly property string cavaConfigDir: homeDir + "/.config/cava"
    readonly property string cavaConfigPath: cavaConfigDir + "/quickshell.conf"
    ...
    function syncPlayerState() {
        ...
        lastTitle = player.trackTitle || player.identity || ""
    }
    ...
    Process {
        ...
        command: ["bash", "-c", `
            ...
            cat > "${HOME}/.config/cava/quickshell.conf" << 'CEOF'
[general]
bars = 24
framerate = 25
